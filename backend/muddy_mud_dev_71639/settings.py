"""
Django settings for muddy_mud_dev_71639 project.
...
ROOT_URLCONF = 'muddy_mud_dev_71639.urls'
...
WSGI_APPLICATION = 'muddy_mud_dev_71639.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_mud_dev_71639 API",
    "DESCRIPTION": "API documentation for muddy_mud_dev_71639 App",
    "VERSION": "v1",
}
